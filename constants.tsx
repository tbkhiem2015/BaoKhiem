...
export const MEDIA: MediaMention[] = [
  { id: "m1", source: "Báo Tài năng Việt", title: "Cậu bé lớp 5 đam mê lập trình giải thuật", link: "#" },
  { id: "m2", source: "Báo An Giang", title: "Gương mặt tiêu biểu Tin học trẻ tỉnh An Giang", link: "#" },
  { id: "m3", source: "Giáo dục Thời đại", title: "Phương pháp học tập sáng tạo của Trần Bảo Khiêm", link: "#" },
  { id: "m4", source: "Báo Sinh viên ĐH An Giang", title: "Tài năng nhí trường Thực hành Sư phạm", link: "#" }
];

export const YOUTUBE_CHANNELS: YoutubeChannel[] = [
  { id: "y1", name: "Khiêm Gaming", link: "https://youtube.com/@KhiemGaming" },
  { id: "y2", name: "Học Cùng Bảo Khiêm", link: "https://youtube.com/@HocCungBaoKhiem" }
];
